...
**[Gate](https://github.com/penumbraforge/gate)** — The first secret scanner that fixes what it finds. 281 detection rules, credential verification, auto-remediation across 9 languages, incident response workflows, and compliance reports. Free, open source, runs 100% on your machine.
...
**[penumbraforge.com](https://penumbraforge.com)** — 79 privacy-first developer and security tools, 12 hands-on offensive and defensive security labs, and a technical blog. All tools run client-side with no tracking, no accounts, no data collection.
